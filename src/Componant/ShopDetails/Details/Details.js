                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner bg-light">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src="/static/img/product-1.jpg" alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="/static/img/product-2.jpg" alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="/static/img/product-3.jpg" alt="Image"/>
                        </div>
                        <div className="carousel-item">
                            <img className="w-100 h-100" src="/static/img/product-4.jpg" alt="Image"/>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="media mb-4">
                                        <img src="/static/img/user.jpg" alt="Image" className="img-fluid mr-3 mt-1" style={{width: "45px"}}/>
